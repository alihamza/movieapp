...
| Name             | Description   |
| :-------------:|--------------|
| [React Native](https://github.com/facebook/react-native/releases/tag/v0.44.0) |  Build Native Mobile Apps using JavaScript and React. |
...
```sh
$ git clone git@github.com:alihamza/movieapp.git
$ cd movieapp
